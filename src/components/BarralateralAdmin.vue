<template>
    <div>
        <aside class="sidebar">
        <router-link class="botones" @mouseover="activarColorGris()" @mouseleave="restaurarColorboton()" :color="coloresBotones1">Inicio</router-link>  
        ...
        <router-link to="clases"><v-btn class="botones" @mouseover="activarColorGris()" @mouseleave="restaurarColorboton()" :color="coloresBotones1">Clases</v-btn> </router-link>
...
const coloresBoton = ref('grey');

function activarColorGris() {
  coloresBoton.value = 'grey';
}
